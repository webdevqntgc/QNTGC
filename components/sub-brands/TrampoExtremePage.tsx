      ...
      <div className="container-page">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="mt-10">
              <div className="text-xs font-bold uppercase tracking-[0.25em] text-white/65">Follow Trampo Extreme</div>
              <div className="mt-3 flex flex-wrap justify-center gap-3">
                <SocialIconButton href="https://www.instagram.com/trampoqatar" type="instagram" hoverColor={TX.orange} />
                <SocialIconButton href="https://www.facebook.com/trampoqatar/" type="facebook" hoverColor={TX.orange} />
              </div>
            </div>
          </div>
        </motion.div>
